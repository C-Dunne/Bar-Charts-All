class PlotChart {
    constructor(obj) {
        ...
        this.circleWidth = obj.circleWidth;
        this.circleColour = obj.circleColour;
    ...
    render() {
        ...
        //gap width
        let gap = (this.chartWidth - (this.data.length * this.circleWidth)) / (this.data.length + 1);
        ...
        for (let i = 0; i < this.data.length; i++) {
            ...
            if (this.data[i][this.yValue] == 0) {
                // done to remove circles with value of zero
            } else {
                ellipse((this.circleWidth / 2) + gap, -(this.data[i][this.yValue] * this.scale), this.circleWidth, this.circleWidth);
                // ellipse(x1,y1,diameterX,diameterY)
            ...
            //gap+circlewidth = distance between each circle
            translate(gap + this.circleWidth, 0);
        }
        pop();
        pop();
    }
